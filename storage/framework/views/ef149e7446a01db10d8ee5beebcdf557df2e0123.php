...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="text-gray-900 dark:text-white"
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                <h1 class="text-gray-900 dark:text-white"><span style="font-size: 45px; color: #8a6dd9;">Bespoke
                        Schools</span> - <small>
                        &nbsp;</small></h1>
                ...
                <img class="ml-4" src="<?php echo e(asset('bootstrap-5-1.svg')); ?>" height="70" alt="Bootstrap 5">
            </div>
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    Laravel v<?php echo e(Illuminate\Foundation\Application::VERSION); ?> (PHP v<?php echo e(PHP_VERSION); ?>) . Bootstrap 5.x
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\User\Downloads\Compressed\Unified\Unifiedtransform-master\resources\views/welcome.blade.php ENDPATH**/ ?>